 ...
 */
//블루투스 스피커용 리스트 뷰
public class SpeakerSelectAdapter extends ArrayAdapter<PairedDevice> {

    Context m_context;
    List<PairedDevice> m_listData;

    public SpeakerSelectAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<PairedDevice> objects) {
